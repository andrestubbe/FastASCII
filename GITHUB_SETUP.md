...
git branch -M main
git add -A
git commit -m "feat: initial commit for FastASCII v0.1.0"
```

### 2. Connect Remote Repository
Once the repository is created on GitHub under `andrestubbe/FastASCII`:
```bash
git remote add origin https://github.com/andrestubbe/FastASCII.git
...
```bash
gh repo edit andrestubbe/FastASCII \
